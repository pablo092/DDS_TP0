...
public class ConsultarDatosView extends Dialog<ConsultarDatos> {
	...
	protected void createFormPanel(Panel mainPanel) {
		...
		columnaFechaCreacion.setTitle("Fecha de Creaci�n").bindContentsToProperty("fechaCreacion");
		
		Column<Nota> columnaFechaModificacion = new Column<Nota>(tableNotas);
		columnaFechaModificacion.setTitle("Fecha de Modificaci�n").bindContentsToProperty("fechaModificacion");
